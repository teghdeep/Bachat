  ...
  User.register(
    ...
    (err, user) => {
      if (err) {
        ...
        if (req.body.income) user.income = req.body.income;
        if (req.body.familymembers) user.familymembers = req.body.familymembers;
        ...
        user.save((err, user) => {
          ...
          var mail = {
            from: USER,
            to: user.username,
            subject: "New Signup on Bachat2020",

            html:
              "<html><body><h3>Welcome to Bachat 2020 Family </h3></body></html>",
          };
